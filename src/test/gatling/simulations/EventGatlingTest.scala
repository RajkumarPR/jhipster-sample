...
class EventGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Event entity")
        ...
        .repeat(2) {
            ...
            .put("/api/events")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "eventVenue":"SAMPLE_TEXT", "costIncludes":"SAMPLE_TEXT", "specialInstructions":"SAMPLE_TEXT", "isActive":null, "isApproved":null, "isBookable":null, "isClosed":null, "isOnlyEnquiry":null, "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z", "eventContact":"SAMPLE_TEXT", "eventType":"0", "videoLink":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
