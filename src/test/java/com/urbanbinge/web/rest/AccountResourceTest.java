...
import com.urbanbinge.domain.Authority;
import com.urbanbinge.domain.User;
import com.urbanbinge.repository.AuthorityRepository;
import com.urbanbinge.repository.UserRepository;
import com.urbanbinge.security.AuthoritiesConstants;
import com.urbanbinge.service.impl.MailService;
import com.urbanbinge.service.impl.UserService;
import com.urbanbinge.web.rest.dto.UserDTO;
...
public class AccountResourceTest {
    ...
    public void testRegisterValid() throws Exception {
        UserDTO u = new UserDTO(
            ...
            "urbanbinge.com",       //website
            "8197251999",           //mobile no.
            "Bidar",                //city
            "Java",                 // experties
            "software developer",   //aboutme
            "Raj",                  //nick name
            null,                   //dob
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        UserDTO dup = new UserDTO(u.getLogin(), u.getPassword(), u.getLogin(), u.getLastName(),
            "alicejr@example.com", u.getLangKey(),u.getProfilePic(),u.getWebsite(),u.getMobileNo(),
            u.getCity(),u.getExpertise(),u.getAboutMe(),u.getNickName(),u.getDob(), u.getRoles());
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        UserDTO dup = new UserDTO("johnjr", u.getPassword(), u.getLogin(), u.getLastName(),
            u.getEmail(), u.getLangKey(),u.getProfilePic(),u.getWebsite(),u.getMobileNo(),
            u.getCity(),u.getExpertise(),u.getAboutMe(),u.getNickName(),u.getDob(), u.getRoles());
